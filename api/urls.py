...
urlpatterns = [
    ...
    path('auth/register',                        views.auth_register,                  name='auth-register-ns'),
    path('auth/login/',                          views.auth_login,                     name='auth-login'),
    path('auth/login',                           views.auth_login,                     name='auth-login-ns'),
    path('auth/logout/',                         views.auth_logout,                    name='auth-logout'),
    path('auth/logout',                          views.auth_logout,                    name='auth-logout-ns'),
    path('auth/me/',                             views.auth_me,                        name='auth-me'),
    path('auth/me',                              views.auth_me,                        name='auth-me-ns'),
